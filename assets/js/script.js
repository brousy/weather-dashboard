...
//Function to display today's weather on page
    function displayTodayWeather(city, searchTermCity, searchTermCountry) {
        ...
        citySearchTerm.textContent = searchTermCity + ", " + searchTermCountry + " - " + currentDate;
        ...
        .then(function(response) {
            if (response.ok) {
                response.json().then(function(data) {
                    ...
                    getForecastCityWeather(latitude, longitude); // Pass latitude and longitude to the forecast function
                })
            } else {
                alert("Error" + response.statusText)
                console.log(response)
...
function getForecastCityWeather(latitude, longitude) {
